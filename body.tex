...
\section{Karty}
	...
	\label{sec:characters}
		...
		\larpcardcharacter{Amelia}{
			...
			Uważasz, że inne wampiry nie mają prawa należeć do żadnych sekt jak Camarilla, a tylko przynależność klanowa się liczy.
				...
				\begin{itemize}[noitemsep]
					...
					\item \larpcardlinepower{Broń}{Srebrny miecz}{\larpcardlineweapon{+2}}{Specjalny miecz na potwory. Nie masz drugiego. Zadaje poważne obrażenia wampirom.}
				\end{itemize}
			}
			{
				\begin{itemize}[noitemsep]
		...
		\larpcardcharacter{Dionizy Duczeski}{
			...
			Mistrz Larpu może zaakceptować albo powiedzieć, które z przedmiotów się nie nadają.}
			{
				\begin{itemize}[noitemsep]
					...
					\item \larpcardlinepower{Broń}{Zawodny pistolecik na krew}{\larpcardlineversus{3}{Siła}}{Musisz wykonać Pobudzenie krwi, aby naładować pistolet. Zadaje \larpcardlineweapon{-1} poważnych obrażeń wampirom.}
				\end{itemize}
			}
			{
				\begin{enumerate}[noitemsep]
		...
		\thispagestyle{empty}
		\larpcardcharacter{Duch}{
			\larpcardlinespecies{Upiór}{Zjawy}{-}}{
			...
			Możesz kogoś opętać, aby chodził razem z tobą i wykonywał twoje rozkazy, używasz do tego czapeczki ze sznurkiem.
			...
			Oblanie wodą święconą zadaje ci poważne obrażenia i zabiera 1 punkt ektoplazmy.}
			{
				\begin{itemize}[noitemsep]
					...
					\item \larpcardlinepower{Spirytualizm}{Przejęcie kontroli}{\larpcardlineversus{6}{Siła Woli}}{Przejmujesz kontrolę nad kimś, zakładając mu czapeczkę ze sznurkiem.}
					\item \larpcardlinepower{Spirytualizm}{Gadanie w myślach}{\larpcardlineversus{8}{Siła Woli}}{Możesz komuś powiedzieć coś w myślach i rozmawiać prywatnie i nie musisz go łapać.}
					\item \larpcardlinepower{Spirytualizm}{Wyrwanie duszy}{\larpcardlineversus{6}{3}}{Tworzysz nowego ducha i dajesz mu życia w liczbie sukcesów.}
				\end{itemize}
			}
			{
				\begin{enumerate}[noitemsep]
		...
		\larpcardcharacter{Szlachcic Alfa}{
			...
			Jego \textbf{Siła} i Życie podwajają się.}
			{
				\begin{itemize}[noitemsep]
					...
					\item \larpcardlinepower{Transformacja}{Kształtowanie ciała}{\larpcardlineversus{6}{Siła}}{Pozwala ci na zmianę czyjegoś wyglądu, aby wzbudzić czyjąś nieufność albo podszyć.}
		...
		\larpcardlinespecies{Potwór}{Bestia przyzwana przez Księcia}{Dworzanie Księcia}}{
			...
			}
			{
				\begin{itemize}[noitemsep]
					...
					\item \larpcardlinepower{Potworzastość}{Absorpcja}{\larpcardlineversus{7}{Siła}}{Możesz absorbować krew lub punkty życia twojej ofiary w żołądku.}
					...
					\item \larpcardlinepower{Potworzastość}{Złożenie jaj}{\larpcardlineversus{6}{3}}{Składasz jaja w kimś martwym lub w letargu. Liczba sukcesów oznacza ilość żyć twojego podopiecznego.}
				\end{itemize}
			}
			{
				\begin{itemize}[noitemsep]
...
% Zakuć Obrońcę w łańcuch
% Łańcuch do walki wręcz
